...
#[cfg(test)]
mod test {
    use crate::fp::{U256, U384, U576};

    type U128X128 = UnsignedSymmetric<U256, U384, 4, 6>;
    type U192X192 = UnsignedSymmetric<U384, U576, 6, 9>;

    use super::*;
    #[test]
    fn test_sum() {
        let one: U128X128 = UnsignedSymmetric::new(U256::one());
        let two: U128X128 = UnsignedSymmetric::new(U256::one() * 2);
    ...
    #[test]
    fn test_mul() {
        let real_one: U128X128 = UnsignedSymmetric::new(U256::one() << 128);
        let real_two: U128X128 = UnsignedSymmetric::new((U256::one() << 128) * 2);
        assert_eq!(real_two * real_one, real_two);
    }

    #[test]
    fn test_mul_large() {
        let x: U128X128 = UnsignedSymmetric::new(U256::one() << 138);
        let y: U128X128 = UnsignedSymmetric::new(U256::one() << 158);
        let res: U128X128 = UnsignedSymmetric::new(U256::one() << 168);
        assert_eq!(x * y, res);
    }
    ...
    fn test_floor() {
        ...
        let cases = [
            U128X128::new(unit * 2),
            U128X128::new(unit * 34141),
            U128X128::new(unit * 1435134134),
            U128X128::new(unit * 1),
            U128X128::new((unit >> 2) + 111),
            U128X128::new((unit >> 34) + 33),
            U128X128::new(unit << 32),
        ];
        for x in cases {
            let x_inner = x.underlying;
            assert_eq!(x.floor(), U128X128::new((x_inner >> 128) << 128));
        }
    }
    ...
    fn test_fract() {
        ...
        let cases = [
            ...
            U128X128::new(unit * 6),
            U128X128::new((unit << 2) + 111),
            U128X128::new((unit << 34) + 13),
            U128X128::new(unit << 32),
            U128X128::new((unit << 64) + 1231),
            U128X128::new(U256([1, 1, 1, 1])),
        ];
        for x in cases {
            let x_inner = x.underlying;
            assert_eq!(x.fract(), U128X128::new((x_inner << 128) >> 128));
        }
    }

    #[test]
    fn test_integer_sqrt() {
        let four: U128X128 = UnsignedSymmetric::new((U256::one() << 128) * 4);
        let two: U128X128 = UnsignedSymmetric::new((U256::one() << 128) * 2);
        assert_eq!(four.integer_sqrt(), two);
    }

    #[test]
    fn test_integer_sqrt_u192x192() {
        let four: U192X192 = UnsignedSymmetric::new((U384::one() << 192) * 4);
        let two: U192X192 = UnsignedSymmetric::new((U384::one() << 192) * 2);
        assert_eq!(four.integer_sqrt(), two);
    }
}
